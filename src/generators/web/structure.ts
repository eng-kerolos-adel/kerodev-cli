...
export async function generateWebFolderStructure(ctx: GeneratorContext): Promise<void> {
  ...
  const frameworkDirs: Record<string, string[]> = {
    next: [
      'app/(auth)',
      'app/(dashboard)',
      'app/api',
  ...
  if (cfg.stateManager === 'redux') allRelDirs.push('store/slices', 'store/middleware');
  if (cfg.stateManager === 'zustand') allRelDirs.push('store');
  if (cfg.stateManager === 'jotai') allRelDirs.push('atoms');
...
function generateUtilsStub(): string {
...
function generateTypesStub(): string {
...
function generateConstantsStub(cfg: WebProjectConfig): string {
...
function generateConfigStub(): string {
...
function generateServiceStub(): string {
...
function generateStoreStub(stateManager: string): string {
