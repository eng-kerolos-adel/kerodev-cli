...
export function generateMainDart(config: FlutterProjectConfig, safeName: string): string {
...
export function generateAppDart(config: FlutterProjectConfig): string {
...
function getStateManagerImport(sm: FlutterProjectConfig['stateManager']): string {
  switch (sm) {
...
function getStateManagerWrapper(sm: FlutterProjectConfig['stateManager'], safeName: string): string {
  switch (sm) {
