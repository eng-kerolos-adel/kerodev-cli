...
import type { FlutterProjectConfig, GeneratorContext } from '../../types/index.js';
import { log, createSpinner, printSuccessScreen } from '../../utils/ui.js';
import { run } from '../../utils/exec.js';
import { writeFile, createDirStructure } from '../../utils/fs.js';
...
export async function generateFlutterProject(config: FlutterProjectConfig): Promise<void> {
...
async function writeFlutterStubs(ctx: GeneratorContext): Promise<void> {
  const cfg = ctx.config as FlutterProjectConfig;
...
async function setupFlutterDevOps(ctx: GeneratorContext): Promise<void> {
  const cfg = ctx.config as FlutterProjectConfig;
