...
import { UI_REQUIRES_TAILWIND, FRAMEWORK_SUPPORTS_SHADCN, NODE_MIN_VERSION, } from '../constants/index.js';
...
export function validateProjectName(name) {
    ...
    if (!name || name.length === 0)
        v.error('Project name is required.');
    if (name.length > 214)
        v.error('Project name too long (max 214 chars).');
