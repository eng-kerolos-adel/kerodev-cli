...
export async function installShadcn(ctx) {
    ...
    await writeFile(path.join(ctx.targetDir, 'components.json'), JSON.stringify(componentsJson, null, 2));
    // Install core ShadCN dependencies
    await run(getAddCommand(pm, false, 'class-variance-authority', 'clsx', 'tailwind-merge', 'lucide-react'), { cwd: ctx.targetDir });
