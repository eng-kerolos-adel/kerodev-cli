...
export async function installI18n(ctx) {
    ...
    // ── Providers ────────────────────────────────────────────────────────────
    await writeFile(path.join(srcRoot, 'providers', 'I18nProvider.tsx'), generateI18nProvider());
    // ── Custom hook ───────────────────────────────────────────────────────────
    await writeFile(path.join(srcRoot, 'hooks', 'useDirection.ts'), generateDirectionHook());
    // ── Language Switcher component ───────────────────────────────────────────
    await writeFile(path.join(srcRoot, 'components', 'shared', 'LanguageSwitcher.tsx'), generateLanguageSwitcher());
...
function generateDirectionHook() {
...
async function patchNextConfig(base) {
