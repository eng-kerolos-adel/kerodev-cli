...
export async function installSupabase(ctx) {
    ...
    if (framework === 'next') {
        ...
        // Auth helpers
        await writeFile(path.join(srcRoot, 'lib', 'supabase', 'auth.ts'), generateSupabaseAuth());
    ...
    // ── Hook ──────────────────────────────────────────────────────────────────
    await writeFile(path.join(srcRoot, 'hooks', 'useSupabaseAuth.ts'), generateSupabaseAuthHook());
    // ── Env vars ──────────────────────────────────────────────────────────────
...
function generateSupabaseMiddleware() {
    return `import { createServerClient } from '@supabase/ssr';
...
function generateNextMiddleware() {
...
function generateSupabaseBarrel() {
...
// ─── Auth Hook ────────────────────────────────────────────────────────────────
function generateSupabaseAuthHook() {
    return `'use client';
...
// ─── Auth Pages ───────────────────────────────────────────────────────────────
function generateSupabaseLoginPage() {
    return `'use client';
...
function generateSupabaseRegisterPage() {
    return `'use client';
