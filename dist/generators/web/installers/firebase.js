...
export async function installFirebase(ctx) {
    ...
    // ── Auth Context & Hook ───────────────────────────────────────────────────
    await writeFile(path.join(srcRoot, 'providers', 'FirebaseAuthProvider.tsx'), generateAuthProvider());
    await writeFile(path.join(srcRoot, 'hooks', 'useFirebaseAuth.ts'), generateAuthHook());
    // ── Auth Pages ────────────────────────────────────────────────────────────
...
function generateFirebaseStorage() {
    return `import {
  ref,
...
function generateFirebaseBarrel() {
